import { Additive, FoodCategory, FoodFilter, FoodItem } from '../types';
 ...
 */
export const additiveDatabase: Record<string, Additive> = {
    // ========== PENGUAT RASA ==========
    "E621": {
 ...
 */
export function searchFoods(query: string, filters: FoodFilter = {}): FoodItem[] {
 ...
 */
export function getUniqueAdditives(foods: FoodItem[]): string[] {
 ...
 */
export function getCategoryById(categoryId: string): FoodCategory | null {
